...
interface TeleopScoutPageProps {
...
// TODO: this page, /scout/2025/auto, and /scout/2025/pit are temporary
// placeholders. They will be merged into a single scouting flow.
export default async function TeleopScoutPage({
  searchParams,
}: TeleopScoutPageProps) {
  ...
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-col items-center gap-6 px-6 py-16 text-center">
      ...
      <div>
        <h1 className="text-3xl font-bold text-white">Teleop Scouting</h1>
