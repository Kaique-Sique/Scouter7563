...
// TODO: this page, /scout/2025/teleop, and /scout/2025/pit are temporary
...
export default async function AutoScoutPage({
  ...
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-col items-center gap-6 px-6 py-16 text-center">
      ...
      <div>
        <h1 className="text-3xl font-bold text-white">Auto Scouting</h1>
